...
namespace SistemaVentas.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(DbventasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,NombreEmpresa,Telefono,CorreoElectronico")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProveedor,NombreEmpresa,Telefono,CorreoElectronico")] Proveedore proveedore)
        {
